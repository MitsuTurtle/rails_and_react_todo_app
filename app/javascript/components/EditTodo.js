    ...
    <>
      ...
      <div>
        <div>
          ...
          <InputName type="text" name="name" value={currentTodo.name} onChange={handleInputChange} />
          <div>
        ...
        {currentTodo.is_completed ? <IsCompeletedButton onClick={() => updateIsCompleted(currentTodo)}>Uncompleted</IsCompeletedButton> : <IsCompeletedButton onClick={() => updateIsCompleted(currentTodo)}>Completed</IsCompeletedButton>}
